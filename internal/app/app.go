...
func New(cfg config.Config) (*App, error) {
	...
	adminsService := admins.NewService(adminsRepository, firebaseServices.FirebaseVerifier)
	...
	notificationSender := notifications.NewSender(firebaseServices.Messaging)
	notificationDispatcher := notifications.NewDispatcher(notificationsRepository, notificationSender)
	eventsService.SetPushNotifier(notificationDispatcher)
	...
	corsMiddleware := httpmiddleware.NewCORS()
